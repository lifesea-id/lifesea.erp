...
class Utility extends Model
{
    ...
    public static function settingsById($user_id)
    {
        ...
        $settings = [
            ...
            "site_time_format" => "g:i A",
            "company_name" => "LifeSea",
            "company_address" => "Malang, East Java, Indonesia",
            "company_city" => "Malang",
            "company_state" => "East Java",
            "company_zipcode" => "",
            "company_country" => "Indonesia",
            "company_telephone" => "+6287763500146",
            "invoice_prefix" => "#INVO",
            "invoice_color" => "ffffff",
            "proposal_prefix" => "#PROP",
            "proposal_color" => "ffffff",
            ...
            "email_verification" => "on",
            'cookie_text' => 'We use cookies to ensure that we give you the best experience on our website. If you continue to use this site we will assume that you are happy with it.',
            "company_logo_light" => "LifeSea Logolight.png",
            "company_logo_dark" => "LifeSea Logodark.png",
            "company_favicon" => "LiveSea Favicon.png",
            "cust_theme_bg" => "on",
            "cust_darklayout" => "off",
            "color" => "",
            "SITE_RTL" => "off",
